...
const loaders = { quotes: listQuotes, samples: listSamples, orders: listOrders, business: getBusiness, addresses: listAddresses };
const labels = { quotes: "Quotes", samples: "Sample requests", orders: "Orders", business: "Business profile", addresses: "Addresses" };
