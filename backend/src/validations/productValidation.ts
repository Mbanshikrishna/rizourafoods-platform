...
export const createProductSchema = z.object({
  body: z.object({
    ...
    categoryId: z.string().min(1).optional(), sku: z.string().trim().min(3).max(80).regex(/^[A-Za-z0-9_-]+$/).optional(), brand: z.string().max(100).optional(), baseUnit: z.enum(["kg", "g", "l", "ml", "unit"]).optional(), packSize: z.coerce.number().positive().max(100000).optional(), packUnit: z.enum(["kg", "g", "bag", "box", "carton", "unit"]).optional(), hsnCode: z.string().max(30).optional(),
...
export const updateProductSchema = z.object({
  ...
  body: z
    .object({
      ...
      categoryId: z.string().min(1).nullable().optional(), sku: z.string().trim().min(3).max(80).regex(/^[A-Za-z0-9_-]+$/).nullable().optional(), brand: z.string().max(100).nullable().optional(), baseUnit: z.enum(["kg", "g", "l", "ml", "unit"]).nullable().optional(), packSize: z.coerce.number().positive().max(100000).nullable().optional(), packUnit: z.enum(["kg", "g", "bag", "box", "carton", "unit"]).nullable().optional(), hsnCode: z.string().max(30).nullable().optional(),
