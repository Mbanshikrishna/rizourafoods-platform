...
export const crmController = {
  ...
  approveCustomer: async (req: Request, res: Response) => res.json({ data: await customerService.setStatus(req.params.id as string, "ACTIVE") }),
  suspendCustomer: async (req: Request, res: Response) => res.json({ data: await customerService.setStatus(req.params.id as string, "SUSPENDED") }),
  updateBusiness: async (req: Request, res: Response) => res.json({ data: await customerService.updateCrmBusiness(req.params.id as string, req.body) }),
  reviewBusiness: async (req: Request, res: Response) => res.json({ data: await customerService.reviewBusiness(req.params.id as string, req.body.status) }),
